<?php
	...
	$from = $mail;
	$encabezados = "From:".$nombre."<" . $from. ">"; //optional headerfields
	$mensaje = "Asunto: Financiamiento - Solicitud de la pagina de internet Suzuki Colima para cotizar.\n\n";
	...
	mail('mercadotecnia@suzukicolima.com.mx', 'Financiamiento - Solicitud de la pagina de internet Suzuki Colima para cotizar.', $mensaje, $encabezados) or die('¡Error!');
	//mail('cold_space@hotmail.com', 'Financiamiento - Solicitud de la pagina de internet Suzuki Colima para cotizar.', $mensaje, $encabezados) or die("¡Error!");
